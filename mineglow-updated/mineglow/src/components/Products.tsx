...
const categories = [
  ...
  { label: 'Pasqyra',  gridClass: 'sh-4', img: '/images/cat-floke.png' },
  { label: 'Dekorime',          gridClass: 'sh-5', img: '/images/cat-dekorime.png' },
  { label : 'Shporta', gridClass: 'sh-6', img: '/images/shporta2.png' },
]
